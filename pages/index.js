...
export default function Home() {
  ...
  <meta name="twitter:title" content={`${data.name} - Zoology Student & Filmmaker`} />
  <meta
  ...
  <meta name="google-site-verification" content="x_VXLipNZRtrP88jfkLbC2kdGGRxIBAgR4Achp5XKvU" />
